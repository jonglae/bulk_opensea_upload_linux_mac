...
def supportURL():
    webbrowser.open_new("https://opensea.io/collection/toriya")
...
class WebImage:
    ...
    def get(self):
        return self.image
imageurl = "https://lh3.googleusercontent.com/czsvAdvCSGHOn52thXUjpTxTrGmi8IEd8ADayexTqgxZ8JUut-qpgumdAJJDrW19MlGTpzIan1PXKJtXD1RB_NCF4KfaGgYksqf6Pf4"
...
def open_chrome_profile():
    subprocess.Popen(
        [
            # "start",
            "chrome --remote-debugging-port=8989",
        ...
        if check_exists_by_xpath(driver, '//h4[text()="Almost done"]'):
            ...
            if check_exists_by_tagname('iframe'):
                ...
                try:
                    ...
                    time.sleep(2)
                    checkbox_button = WebDriverWait(driver, 10).until(ExpectedConditions.element_to_be_clickable((By.ID ,"recaptcha-audio-button")))
                    checkbox_button.click()
                    pass
